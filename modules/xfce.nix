...
in
{
  config = lib.mkIf (config.desktop == "xfce") {
    ...
    environment.etc = {
      ...
      "xdg/xfce4/xfconf/xfce-perchannel-xml/xsettings.xml".text = xfconfChannel "xsettings" ''
      ...
      "xdg/xfce4/xfconf/xfce-perchannel-xml/xfwm4.xml".text = xfconfChannel "xfwm4" ''
      ...
      "xdg/xfce4/xfconf/xfce-perchannel-xml/xfce4-desktop.xml".text = xfconfChannel "xfce4-desktop" ''
      ...
      "xdg/xfce4/xfconf/xfce-perchannel-xml/xfce4-terminal.xml".text = xfconfChannel "xfce4-terminal" ''
      ...
      "xdg/xfce4/xfconf/xfce-perchannel-xml/xfce4-notifyd.xml".text = xfconfChannel "xfce4-notifyd" ''
